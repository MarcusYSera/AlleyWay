...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/about-B2As--l0.js").then((m) => m.default || m)
  },
  {
    name: "contact",
    path: "/contact",
    ...
    component: () => import("./_nuxt/contact-BSOa-kSd.js").then((m) => m.default || m)
  },
  {
    name: "game-page",
    path: "/game-page",
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-CcL3CoUV.js").then((r) => r.default || r));
